...
// define bit masks so the font is human readable 
...
// ASCII Space through lowercase z rendered as 5 tall, three wide characters in a 6x8 space with each line represented as a byte that's a bit mask of the pixles
